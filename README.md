# spacetraders Terraform Provider

The `spacetraders` Terraform provider is used to manage resources on `registry.terraform.io/spacetraders/spacetraders`.
...
provider_installation {
  dev_overrides {
    "registry.terraform.io/spacetraders/spacetraders" = "<path to go bin directory>"
  }
  direct {}
}
```
...
address `registry.terraform.io/spacetraders/spacetraders` can be used once the provider is
