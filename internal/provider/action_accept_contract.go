...
func (r *AcceptContractAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Accept a contract by ID. \n\nYou can only accept contracts that were offered to you, were not accepted yet, and whose deadlines has not passed yet.", Attributes: map[string]schema.Attribute{"contract_id": schema.StringAttribute{MarkdownDescription: "The contract ID to accept.", Required: true}}}
}
