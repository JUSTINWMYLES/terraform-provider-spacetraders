...
func (r *SupplyConstructionAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Supply a construction site with the specified good. Requires a waypoint with a property of `isUnderConstruction` to be true.\n\nThe good must be in your ship's cargo. The good will be removed from your ship's cargo and added to the construction site's materials.", Attributes: map[string]schema.Attribute{"ship_symbol": schema.StringAttribute{MarkdownDescription: "The symbol of the ship supplying construction materials.", Required: true}, "system_symbol": schema.StringAttribute{MarkdownDescription: "The system symbol", Required: true}, "trade_symbol": schema.StringAttribute{MarkdownDescription: "The symbol of the good to supply.", Required: true}, "units": schema.Int64Attribute{MarkdownDescription: "Amount of units to supply.", Required: true}, "waypoint_symbol": schema.StringAttribute{MarkdownDescription: "The waypoint symbol", Required: true}}}
}
