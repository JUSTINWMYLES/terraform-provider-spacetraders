...
func (d *GetMyAgentDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Fetch your agent's details.", Attributes: map[string]schema.Attribute{"account_id": schema.StringAttribute{Computed: true}, "credits": schema.Int64Attribute{Computed: true}, "headquarters": schema.StringAttribute{Computed: true}, "ship_count": schema.Int64Attribute{Computed: true}, "starting_faction": schema.StringAttribute{Computed: true}, "symbol": schema.StringAttribute{Computed: true}}}
}
