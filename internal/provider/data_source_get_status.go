...
func (d *GetStatusDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Return the status of the game server.\nThis also includes a few global elements, such as announcements, server reset dates and leaderboards.", Attributes: map[string]schema.Attribute{"announcements": schema.ListNestedAttribute{Computed: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"body": schema.StringAttribute{Computed: true}, "title": schema.StringAttribute{Computed: true}}}}, "description": schema.StringAttribute{Computed: true}, "health": schema.SingleNestedAttribute{Computed: true, Attributes: map[string]schema.Attribute{"last_market_update": schema.StringAttribute{Computed: true}}}, "leaderboards": schema.SingleNestedAttribute{Computed: true, Attributes: map[string]schema.Attribute{"most_credits": schema.ListNestedAttribute{Computed: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"agent_symbol": schema.StringAttribute{Computed: true}, "credits": schema.Int64Attribute{Computed: true}}}}, "most_submitted_charts": schema.ListNestedAttribute{Computed: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"agent_symbol": schema.StringAttribute{Computed: true}, "chart_count": schema.Int64Attribute{Computed: true}}}}}}, "links": schema.ListNestedAttribute{Computed: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"name": schema.StringAttribute{Computed: true}, "url": schema.StringAttribute{Computed: true}}}}, "reset_date": schema.StringAttribute{Computed: true}, "server_resets": schema.SingleNestedAttribute{Computed: true, Attributes: map[string]schema.Attribute{"frequency": schema.StringAttribute{Computed: true}, "next": schema.StringAttribute{Computed: true}}}, "stats": schema.SingleNestedAttribute{Computed: true, Attributes: map[string]schema.Attribute{"accounts": schema.Int64Attribute{Computed: true}, "agents": schema.Int64Attribute{Computed: true}, "ships": schema.Int64Attribute{Computed: true}, "systems": schema.Int64Attribute{Computed: true}, "waypoints": schema.Int64Attribute{Computed: true}}}, "status": schema.StringAttribute{Computed: true}, "version": schema.StringAttribute{Computed: true}}}
}
