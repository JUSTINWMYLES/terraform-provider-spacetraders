...
func (r *RemoveShipModuleAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Remove a module from a ship. The module will be placed in cargo.", Attributes: map[string]schema.Attribute{"ship_symbol": schema.StringAttribute{MarkdownDescription: "The symbol of the ship.", Required: true}, "symbol": schema.StringAttribute{MarkdownDescription: "The symbol of the module to remove.", Required: true}}}
}
