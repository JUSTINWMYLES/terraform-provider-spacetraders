...
func (d *GetMyShipCargoDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Retrieve the cargo of a ship under your agent's ownership.", Attributes: map[string]schema.Attribute{"capacity": schema.Int64Attribute{Computed: true}, "inventory": schema.ListNestedAttribute{Computed: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"description": schema.StringAttribute{Computed: true}, "name": schema.StringAttribute{Computed: true}, "symbol": schema.StringAttribute{Computed: true}, "units": schema.Int64Attribute{Computed: true}}}}, "ship_symbol": schema.StringAttribute{Required: true}, "units": schema.Int64Attribute{Computed: true}}}
}
