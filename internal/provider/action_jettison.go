...
func (r *JettisonAction) Schema(_ context.Context, _ action.SchemaRequest, resp *action.SchemaResponse) {
	resp.Schema = schema.Schema{Description: "Jettison cargo from your ship's cargo hold.", Attributes: map[string]schema.Attribute{"ship_symbol": schema.StringAttribute{MarkdownDescription: "The symbol of the ship.", Required: true}, "symbol": schema.StringAttribute{MarkdownDescription: "The good's symbol.", Required: true}, "units": schema.Int64Attribute{MarkdownDescription: "Amount of units to jettison of this good.", Required: true}}}
}
