...
func (d *GetContractDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Get the details of a specific contract.", Attributes: map[string]schema.Attribute{"accepted": schema.BoolAttribute{MarkdownDescription: "Whether the contract has been accepted by the agent", Computed: true}, "contract_id": schema.StringAttribute{MarkdownDescription: "The contract ID to accept.", Required: true}, "deadline_to_accept": schema.StringAttribute{MarkdownDescription: "The time at which the contract is no longer available to be accepted", Computed: true}, "expiration": schema.StringAttribute{MarkdownDescription: "Deprecated in favor of deadlineToAccept", Computed: true}, "faction_symbol": schema.StringAttribute{MarkdownDescription: "The symbol of the faction that this contract is for.", Computed: true}, "fulfilled": schema.BoolAttribute{MarkdownDescription: "Whether the contract has been fulfilled", Computed: true}, "id": schema.StringAttribute{MarkdownDescription: "ID of the contract.", Computed: true}, "terms": schema.SingleNestedAttribute{MarkdownDescription: "The terms to fulfill the contract.", Computed: true, Attributes: map[string]schema.Attribute{"deadline": schema.StringAttribute{MarkdownDescription: "The deadline for the contract.", Computed: true}, "deliver": schema.ListNestedAttribute{MarkdownDescription: "The cargo that needs to be delivered to fulfill the contract.", Computed: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"destination_symbol": schema.StringAttribute{MarkdownDescription: "The destination where goods need to be delivered.", Computed: true}, "trade_symbol": schema.StringAttribute{MarkdownDescription: "The symbol of the trade good to deliver.", Computed: true}, "units_fulfilled": schema.Int64Attribute{MarkdownDescription: "The number of units fulfilled on this contract.", Computed: true}, "units_required": schema.Int64Attribute{MarkdownDescription: "The number of units that need to be delivered on this contract.", Computed: true}}}}, "payment": schema.SingleNestedAttribute{MarkdownDescription: "Payments for the contract.", Computed: true, Attributes: map[string]schema.Attribute{"on_accepted": schema.Int64Attribute{MarkdownDescription: "The amount of credits received up front for accepting the contract.", Computed: true}, "on_fulfilled": schema.Int64Attribute{MarkdownDescription: "The amount of credits received when the contract is fulfilled.", Computed: true}}}}}, "type": schema.StringAttribute{MarkdownDescription: "Type of contract.", Computed: true}}}
}
