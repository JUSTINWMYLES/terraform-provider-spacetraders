...
func (d *GetAgentDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Get public details for a specific agent.", Attributes: map[string]schema.Attribute{"agent_symbol": schema.StringAttribute{MarkdownDescription: "The agent symbol", Required: true}, "credits": schema.Int64Attribute{MarkdownDescription: "The number of credits the agent has available. Credits can be negative if funds have been overdrawn.", Computed: true}, "headquarters": schema.StringAttribute{MarkdownDescription: "The headquarters of the agent.", Computed: true}, "ship_count": schema.Int64Attribute{MarkdownDescription: "How many ships are owned by the agent.", Computed: true}, "starting_faction": schema.StringAttribute{MarkdownDescription: "The faction the agent started with.", Computed: true}, "symbol": schema.StringAttribute{MarkdownDescription: "Symbol of the agent.", Computed: true}}}
}
