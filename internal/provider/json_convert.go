...
var wireNames = map[string]map[string]string{
	"DeliverContractActionModel": {
		"ship_symbol":  "shipSymbol",
		"trade_symbol": "tradeSymbol",
	},
	"GetAgentDataSourceModel": {
		"agent_symbol":     "agentSymbol",
		"ship_count":       "shipCount",
		"starting_faction": "startingFaction",
	},
	"GetAgentsDataSourceModel": {
		"items.*.ship_count":       "shipCount",
		"items.*.starting_faction": "startingFaction",
	},
	"GetConstructionDataSourceModel": {
		"is_complete":              "isComplete",
		"materials.*.trade_symbol": "tradeSymbol",
		"system_symbol":            "systemSymbol",
		"waypoint_symbol":          "waypointSymbol",
	},
	"GetContractDataSourceModel": {
		"contract_id":                        "contractId",
		"deadline_to_accept":                 "deadlineToAccept",
		"faction_symbol":                     "factionSymbol",
		"terms.deliver.*.destination_symbol": "destinationSymbol",
		"terms.deliver.*.trade_symbol":       "tradeSymbol",
		"terms.deliver.*.units_fulfilled":    "unitsFulfilled",
		"terms.deliver.*.units_required":     "unitsRequired",
		"terms.payment.on_accepted":          "onAccepted",
		"terms.payment.on_fulfilled":         "onFulfilled",
	},
	"GetContractsDataSourceModel": {
		"items.*.deadline_to_accept":                 "deadlineToAccept",
		"items.*.faction_symbol":                     "factionSymbol",
		"items.*.terms.deliver.*.destination_symbol": "destinationSymbol",
		"items.*.terms.deliver.*.trade_symbol":       "tradeSymbol",
		"items.*.terms.deliver.*.units_fulfilled":    "unitsFulfilled",
		"items.*.terms.deliver.*.units_required":     "unitsRequired",
		"items.*.terms.payment.on_accepted":          "onAccepted",
		"items.*.terms.payment.on_fulfilled":         "onFulfilled",
	},
	"GetFactionDataSourceModel": {
		"faction_symbol": "factionSymbol",
		"is_recruiting":  "isRecruiting",
	},
	"GetFactionsDataSourceModel": {
		"items.*.is_recruiting": "isRecruiting",
	},
	"GetJumpGateDataSourceModel": {
		"system_symbol":   "systemSymbol",
		"waypoint_symbol": "waypointSymbol",
	},
	"GetMarketDataSourceModel": {
		"system_symbol":                  "systemSymbol",
		"trade_goods":                    "tradeGoods",
		"trade_goods.*.purchase_price":   "purchasePrice",
		"trade_goods.*.sell_price":       "sellPrice",
		"trade_goods.*.trade_volume":     "tradeVolume",
		"transactions.*.price_per_unit":  "pricePerUnit",
		"transactions.*.ship_symbol":     "shipSymbol",
		"transactions.*.total_price":     "totalPrice",
		"transactions.*.trade_symbol":    "tradeSymbol",
		"transactions.*.waypoint_symbol": "waypointSymbol",
		"waypoint_symbol":                "waypointSymbol",
	},
	"GetMountsDataSourceModel": {
		"ship_symbol": "shipSymbol",
	},
	"GetMyAccountDataSourceModel": {
		"account.created_at": "createdAt",
	},
	"GetMyAgentDataSourceModel": {
		"account_id":       "accountId",
		"ship_count":       "shipCount",
		"starting_faction": "startingFaction",
	},
	"GetMyAgentEventsDataSourceModel": {
		"items.*.created_at": "createdAt",
	},
	"GetMyShipCargoDataSourceModel": {
		"ship_symbol": "shipSymbol",
	},
	"GetMyShipsDataSourceModel": {
		"items.*.cooldown.remaining_seconds":          "remainingSeconds",
		"items.*.cooldown.ship_symbol":                "shipSymbol",
		"items.*.cooldown.total_seconds":              "totalSeconds",
		"items.*.frame.fuel_capacity":                 "fuelCapacity",
		"items.*.frame.module_slots":                  "moduleSlots",
		"items.*.frame.mounting_points":               "mountingPoints",
		"items.*.nav.flight_mode":                     "flightMode",
		"items.*.nav.route.departure_time":            "departureTime",
		"items.*.nav.route.destination.system_symbol": "systemSymbol",
		"items.*.nav.route.origin.system_symbol":      "systemSymbol",
		"items.*.nav.system_symbol":                   "systemSymbol",
		"items.*.nav.waypoint_symbol":                 "waypointSymbol",
		"items.*.reactor.power_output":                "powerOutput",
		"items.*.registration.faction_symbol":         "factionSymbol",
	},
	"GetRepairShipDataSourceModel": {
		"ship_symbol":                 "shipSymbol",
		"transaction.ship_symbol":     "shipSymbol",
		"transaction.total_price":     "totalPrice",
		"transaction.waypoint_symbol": "waypointSymbol",
	},
	"GetScrapShipDataSourceModel": {
		"ship_symbol":                 "shipSymbol",
		"transaction.ship_symbol":     "shipSymbol",
		"transaction.total_price":     "totalPrice",
		"transaction.waypoint_symbol": "waypointSymbol",
	},
	"GetShipCooldownDataSourceModel": {
		"remaining_seconds": "remainingSeconds",
		"ship_symbol":       "shipSymbol",
		"total_seconds":     "totalSeconds",
	},
	"GetShipModulesDataSourceModel": {
		"ship_symbol": "shipSymbol",
	},
	"GetShipNavDataSourceModel": {
		"flight_mode":                     "flightMode",
		"route.departure_time":            "departureTime",
		"route.destination.system_symbol": "systemSymbol",
		"route.origin.system_symbol":      "systemSymbol",
		"ship_symbol":                     "shipSymbol",
		"system_symbol":                   "systemSymbol",
		"waypoint_symbol":                 "waypointSymbol",
	},
	"GetShipyardDataSourceModel": {
		"modifications_fee":              "modificationsFee",
		"ship_types":                     "shipTypes",
		"ships.*.frame.fuel_capacity":    "fuelCapacity",
		"ships.*.frame.module_slots":     "moduleSlots",
		"ships.*.frame.mounting_points":  "mountingPoints",
		"ships.*.purchase_price":         "purchasePrice",
		"ships.*.reactor.power_output":   "powerOutput",
		"system_symbol":                  "systemSymbol",
		"transactions.*.agent_symbol":    "agentSymbol",
		"transactions.*.ship_symbol":     "shipSymbol",
		"transactions.*.ship_type":       "shipType",
		"transactions.*.waypoint_symbol": "waypointSymbol",
		"waypoint_symbol":                "waypointSymbol",
	},
	"GetStatusDataSourceModel": {
		"health.last_market_update":                         "lastMarketUpdate",
		"leaderboards.most_credits":                         "mostCredits",
		"leaderboards.most_credits.*.agent_symbol":          "agentSymbol",
		"leaderboards.most_submitted_charts":                "mostSubmittedCharts",
		"leaderboards.most_submitted_charts.*.agent_symbol": "agentSymbol",
		"leaderboards.most_submitted_charts.*.chart_count":  "chartCount",
		"reset_date":    "resetDate",
		"server_resets": "serverResets",
	},
	"GetSupplyChainDataSourceModel": {
		"export_to_import_map": "exportToImportMap",
	},
	"GetSystemDataSourceModel": {
		"sector_symbol": "sectorSymbol",
		"system_symbol": "systemSymbol",
	},
	"GetSystemWaypointsDataSourceModel": {
		"items.*.chart.submitted_by":    "submittedBy",
		"items.*.chart.submitted_on":    "submittedOn",
		"items.*.chart.waypoint_symbol": "waypointSymbol",
		"items.*.is_under_construction": "isUnderConstruction",
		"items.*.system_symbol":         "systemSymbol",
		"system_symbol":                 "systemSymbol",
	},
	"GetSystemsDataSourceModel": {
		"items.*.sector_symbol": "sectorSymbol",
	},
	"GetWaypointDataSourceModel": {
		"chart.submitted_by":    "submittedBy",
		"chart.submitted_on":    "submittedOn",
		"chart.waypoint_symbol": "waypointSymbol",
	...
	"NavigateShipActionModel": {
		"waypoint_symbol": "waypointSymbol",
	},
	"PatchShipNavActionModel": {
		"flight_mode": "flightMode",
	},
	"RefuelShipActionModel": {
		"from_cargo": "fromCargo",
	},
	"ShipResourceModel": {
		"cooldown.remaining_seconds":          "remainingSeconds",
		"cooldown.ship_symbol":                "shipSymbol",
		"cooldown.total_seconds":              "totalSeconds",
		"frame.fuel_capacity":                 "fuelCapacity",
		"frame.module_slots":                  "moduleSlots",
		"frame.mounting_points":               "mountingPoints",
		"nav.flight_mode":                     "flightMode",
		"nav.route.departure_time":            "departureTime",
		"nav.route.destination.system_symbol": "systemSymbol",
		"nav.route.origin.system_symbol":      "systemSymbol",
		"nav.system_symbol":                   "systemSymbol",
		"nav.waypoint_symbol":                 "waypointSymbol",
		"reactor.power_output":                "powerOutput",
		"registration.faction_symbol":         "factionSymbol",
		"ship_type":                           "shipType",
		"waypoint_symbol":                     "waypointSymbol",
	},
	"SupplyConstructionActionModel": {
		"ship_symbol":  "shipSymbol",
		"trade_symbol": "tradeSymbol",
	},
	"TransferCargoActionModel": {
		"body_ship_symbol": "shipSymbol",
		"trade_symbol":     "tradeSymbol",
	},
	"WarpShipActionModel": {
		"waypoint_symbol": "waypointSymbol",
