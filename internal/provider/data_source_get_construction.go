...
func (d *GetConstructionDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Get construction details for a waypoint. Requires a waypoint with a property of `isUnderConstruction` to be true.", Attributes: map[string]schema.Attribute{"is_complete": schema.BoolAttribute{Computed: true}, "materials": schema.ListNestedAttribute{Computed: true, NestedObject: schema.NestedAttributeObject{Attributes: map[string]schema.Attribute{"fulfilled": schema.Int64Attribute{Computed: true}, "required": schema.Int64Attribute{Computed: true}, "trade_symbol": schema.StringAttribute{Computed: true}}}}, "symbol": schema.StringAttribute{Computed: true}, "system_symbol": schema.StringAttribute{Required: true}, "waypoint_symbol": schema.StringAttribute{Required: true}}}
}
