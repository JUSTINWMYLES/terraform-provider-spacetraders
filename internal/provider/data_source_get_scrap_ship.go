...
func (d *GetScrapShipDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{MarkdownDescription: "Get the value of scrapping a ship. Requires the ship to be docked at a waypoint that has the `Shipyard` trait.", Attributes: map[string]schema.Attribute{"ship_symbol": schema.StringAttribute{MarkdownDescription: "The symbol of the ship.", Required: true}, "transaction": schema.SingleNestedAttribute{MarkdownDescription: "Result of a scrap transaction.", Computed: true, Attributes: map[string]schema.Attribute{"ship_symbol": schema.StringAttribute{MarkdownDescription: "The symbol of the ship.", Computed: true}, "timestamp": schema.StringAttribute{MarkdownDescription: "The timestamp of the transaction.", Computed: true}, "total_price": schema.Int64Attribute{MarkdownDescription: "The total price of the transaction.", Computed: true}, "waypoint_symbol": schema.StringAttribute{MarkdownDescription: "The symbol of the waypoint.", Computed: true}}}}}
}
