---
page_title: "spacetraders_create_ship_ship_scan Action - spacetraders"
subcategory: ""
description: |-
...
# spacetraders_create_ship_ship_scan Action
...
```terraform
action "spacetraders_create_ship_ship_scan" "example" {
  config {
    ship_symbol = "example"
  }
}
